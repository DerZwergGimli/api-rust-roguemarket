...
pub async fn list_todos(store: Store, query: ListQueryParams) -> Result<impl Reply, Infallible> {
...
pub async fn delete_todo(id: i64, store: Store, api_key: String) -> Result<impl Reply, Infallible> {
